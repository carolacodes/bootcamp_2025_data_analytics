"""
Ejercicios de colecciones, comprehensions, indexing, slicing, copias
y manejo de errores.
...
"""
Consignas:
1. Crear una función llamada `lazy_map` que reciba una clave y retorne
    el valor correspondiente de un diccionario predefinido. Si la clave no existe,
    debe retornar `None`

2. Crear una función llamada `get_first_element` que reciba una lista y retorne
    el primer elemento de la lista.

3. Crear una función llamada `make_dict` que reciba dos listas, una de claves y 
    otra de valores, y retorne un diccionario con las claves y valores correspondientes.

4. Dado un diccionario con la estructura {"precios": [100, 200, 300]}.
