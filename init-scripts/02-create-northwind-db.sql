-- ============================================
-- Northwind DB Initialization Script
-- ============================================
-- This script checks if the database exists,
-- creates it if it doesn't, and then executes the rest of the code

-- Check and create the database if it doesn't exist
SELECT 'CREATE DATABASE northwind'
WHERE NOT EXISTS (SELECT FROM pg_database WHERE datname = 'northwind')\gexec

-- Connect to the northwind database
\c northwind

-- Now we execute the rest of the original code
